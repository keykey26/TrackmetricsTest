...
- Create Angular project with ng: `ng new trackmetricstest.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`trackmetricstest.client.esproj`).
